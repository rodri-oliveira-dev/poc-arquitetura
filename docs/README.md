...
- [Terraform state local e backend remoto](adrs/0079-terraform-state-local-e-backend-remoto.md): registra a excecao atual de state local em dev, riscos, gatilhos e estrategia futura em GCS.
