...
- [LedgerService API](development/ledger-api.md): contratos de escrita, headers, idempotencia, Outbox, solicitacao de estorno, solicitacao de reprocessamento e consultas de status.
