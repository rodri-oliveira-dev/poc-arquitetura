...
| ADR                                                                   | Status      | Resumo                                                                                           |
| --------------------------------------------------------------------- | ----------- | ------------------------------------------------------------------------------------------------ |
| [ADR-0016](./0016-api-resilience-timeouts-retries-circuit-breaker.md) | Proposto    | Ponto de melhoria: timeouts/retries/circuit breaker padronizados (HTTP/JWKS e readiness).        |
| [ADR-0015](./0015-contratos-eventos-kafka-versionamento-e-dlq.md)     | Proposto    | Ponto de melhoria: versionamento/compatibilidade de eventos e DLQ para poison messages no Kafka. |
...
| [ADR-0013](./0013-health-liveness-publico.md)                         | Substituído | Consolidado em observabilidade + readiness.                                                      |
| [ADR-0012](./0012-padronizacao-repo-cpm-build-props-editorconfig.md)  | Substituído | Consolidado no README.md.                                                                        |
| [ADR-0011](./0011-migrations-nao-automaticas-no-startup.md)           | Substituído | Consolidado no README.md.                                                                        |
| [ADR-0010](./0010-stack-local-compose-nerdctl.md)                     | Substituído | Consolidado no README.md.                                                                        |
| [ADR-0009](./0009-versionamento-api-url-segment.md)                   | Substituído | Consolidado em ADR-0002/README.                                                                  |
