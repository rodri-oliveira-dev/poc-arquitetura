...
Classificacao atual: arquitetura hibrida, com predominancia de Clean Architecture/DDD em LedgerService e BalanceService, TransferService em evolucao com Saga, persistencia EF Core e Outbox Kafka inicial, elementos hexagonais por portas de persistencia/mensageria onde ja existem adapters, camada HTTP tradicional, workers dedicados para processamento assincrono e CQRS/projecao assincrona entre escrita e leitura.
