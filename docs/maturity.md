...
| OWASP/ZAP ou DAST | Pendente | `docs/reports/aspire-and-owasp-assessment.md` | Ha avaliacao historica e status documental, mas nao houve DAST recente nesta revisao. |
...
- Executar e registrar DAST/OWASP ZAP ou pentest quando houver necessidade de avaliar exposicao dinamica.
