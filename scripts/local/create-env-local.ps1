...
$groups = @(
  @{ Name = "PostgreSQL"; Keys = @("POSTGRES_PASSWORD", "POSTGRES_HOST_PORT", "LEDGER_DB_PASSWORD", "LEDGER_DB_MIGRATOR_PASSWORD", "BALANCE_DB_READ_PASSWORD", "BALANCE_DB_WRITE_PASSWORD", "BALANCE_DB_MIGRATOR_PASSWORD", "TRANSFER_DB_PASSWORD", "TRANSFER_DB_MIGRATOR_PASSWORD", "IDENTITY_DB_PASSWORD", "IDENTITY_DB_MIGRATOR_PASSWORD") },
  ...
  @{ Name = "Kafka/PubSub"; Keys = @("PUBSUB_PROJECT_ID", "PUBSUB_EMULATOR_HOST_PORT", "PUBSUB_LEDGER_EVENTS_TOPIC_ID", "PUBSUB_LEDGER_EVENTS_DLQ_TOPIC_ID", "PUBSUB_BALANCE_SUBSCRIPTION_ID", "PUBSUB_LEDGER_EVENTS_DLQ_INSPECTION_SUBSCRIPTION_ID") },
  @{ Name = "Services"; Keys = @("TRANSFER_SERVICE_HOST_PORT", "IDENTITY_SERVICE_HOST_PORT") },
  ...
  @{ Name = "Observability"; Keys = @("GRAFANA_ADMIN_PASSWORD", "OTEL_ENABLED", "DOCKER_LOG_MAX_SIZE", "DOCKER_LOG_MAX_FILE") }
)
