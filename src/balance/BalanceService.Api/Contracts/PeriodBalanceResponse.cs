...
public sealed class PeriodBalanceResponse
{
    ...
    /// </summary>
    public required string TotalCredits
    {
        get; init;
    }
    ...
    /// </summary>
    public required string TotalDebits
    {
        get; init;
    }
    ...
    /// </summary>
    public required string NetBalance
    {
        get; init;
    }
    ...
    /// </summary>
    public required IReadOnlyList<PeriodBalanceItemResponse> Items
    {
        get; init;
    }
    ...
    /// </summary>
    public required string CalculatedAt
    {
        get; init;
    }
}
