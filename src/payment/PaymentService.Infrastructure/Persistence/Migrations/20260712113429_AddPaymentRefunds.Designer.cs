...
namespace PaymentService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260712113429_AddPaymentRefunds")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaymentService.Domain.Payments.PaymentRefund", b =>
                {
                    ...
                    b.Property<int>("LedgerReversalAttemptCount")
                        .HasColumnType("integer")
                        .HasColumnName("ledger_reversal_attempt_count");

                    b.Property<Guid?>("LedgerReversalId")
                        .HasColumnType("uuid")
                        .HasColumnName("ledger_reversal_id");

                    b.Property<string>("LedgerReversalStatus")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                    ...
                    b.HasIndex("Status", "LedgerReversalStatus", "LedgerNextRetryAt", "LedgerLockedUntil")
            ...
            modelBuilder.Entity("PaymentService.Domain.Payments.PaymentRefund", b =>
                {
                    b.HasOne("PaymentService.Domain.Payments.Payment", null)
                        .WithMany("Refunds")
